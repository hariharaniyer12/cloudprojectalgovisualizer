...
const sort_gif_btn=document.getElementById("gif_head1");
const search_gif=document.getElementById("gif_head2");
const path_gif=document.getElementById("gif_head3");




sort_gif_btn.onclick = function(){
  document.getElementById("Sorting_Algorithms").style.display="block";
}

search_gif.onclick = function(){
  document.getElementById("Searching_Algorithms").style.display="block";
}

path_gif.onclick = function(){
  document.getElementById("PathFinding_Algorithms").style.display="block";
}
